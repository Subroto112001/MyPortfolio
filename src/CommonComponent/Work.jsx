        ...
        <div className="flex flex-col gap-[133px]">
          ...
          <div className=" flex flex-col justify-center items-center gap-[64px]">
            ...
            <div className="w-[450px] h-[400px] flex justify-center items-center  relative">
              ...
              {/* Custom buttons */}
              <div className="custom-prev w-10 h-10 bg-node  text-white rounded-full flex items-center justify-center cursor-pointer absolute top-1/2 left-[-19px] -translate-y-1/2 z-10">
                {swiperIcon.prev}
              </div>
              <div className="custom-next w-10 h-10 bg-node hover:bg-primary-400 text-white rounded-full flex items-center justify-center cursor-pointer absolute top-1/2 right-[-19px] -translate-y-1/2 z-10">
                {swiperIcon.next}
              </div>
            </div>
          </div>
